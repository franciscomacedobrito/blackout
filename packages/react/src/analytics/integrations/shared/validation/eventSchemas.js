 ...
 */
 ...
 export const productBaseWithCurrencySchema = productBaseSchema.concat(
   currencySchema,
 );
 ...
 export const productViewedSchema = productBaseWithCurrencySchema.concat(
   outOfStockSchema,
 );
 ...
 export const productRefundSchema = productsListRefundSchema.concat(
   orderIdSchema,
 );
