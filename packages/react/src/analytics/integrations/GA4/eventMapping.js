...
/**
 * Returns the checkout step edited properties from an event.
 *
 * @param {object} eventProperties - Properties from a track event.
 *
 * @returns {object} Object containing the sort properties.
 */
const getCheckoutStepEditedParametersFromEvent = eventProperties => {
  return {
...
export function getEventProperties(event, data) {
  ...
  switch (event) {
    ...
    case eventTypes.CHECKOUT_STEP_EDITING:
      return getCheckoutStepEditedParametersFromEvent(eventProperties);
