...
import { eventTypes, interactionTypes, pageTypes } from '@farfetch/blackout-analytics';
...
export default {
  ...
  [InternalEventTypes.PRODUCT_UPDATED
    .CHANGE_SIZE]: changeSizeProductInCartSchema,
  [InternalEventTypes.PRODUCT_UPDATED
    .CHANGE_QUANTITY]: changeQuantityProductInCartSchema,
