...
export default {
  ...
  [eventTypes.PRODUCT_REMOVED_FROM_WISHLIST]: productRemovedFromWishlistTrackData,
  [eventTypes.PRODUCT_UPDATED_WISHLIST]: productUpdatedWishlistTrackData,
  [eventTypes.PRODUCT_VIEWED]: productViewedTrackData,
  [eventTypes.SAME_BILLING_ADDRESS_SELECTED]: sameBillingAddressSelectedTrackData,
